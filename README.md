...
Для этого можно использовать *грависы* (обратные кавычки), заключив в них команду при определении переменной или используя конструкцию *$(command)*, например: `mydir=$(pwd)`.
